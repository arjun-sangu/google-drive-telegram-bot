class config:
    ...
    G_DRIVE_CLIENT_ID = "http://1095863260406-5v3ja0vdimfk644g7kkg3ev56h49mtpr.apps.googleusercontent.com"
    G_DRIVE_CLIENT_SECRET = "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"
